...
public class RunTestNG 
{
	...
	String rutaImgEncabezadoML,rutaImgEncabezadoMT,rutaImgEncabezadoTQA,rutaImgEncabezadoCL,platformNameCL,deviceNameCL,platformVersionCL,
	noResetCL,autoGrantPermissionsCL;
	
  @BeforeClass
  @Parameters({"rutaImgML","rutaImgMT","rutaImgTQA","rutaImgCL","platformName","deviceName","platformVersion","noReset","autoGrantPermissions"})
  ...
  @Test(dataProvider = "calculadora",priority=3)
  ...
  @SuppressWarnings("unchecked")
  @Test(dataProvider = "alerts",priority=2)
  ...
  @SuppressWarnings("unchecked")
  @Test(dataProvider = "widgts",priority=1)
