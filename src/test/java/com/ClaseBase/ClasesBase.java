...
public class ClasesBase 
{
	...
	public void enter(By locator,File rutaCarpeta,String generarEvidencia,String msn)throws Exception
	{    
		String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
		((AndroidDriver<MobileElement>) driver).pressKey(new KeyEvent(AndroidKey.ENTER));
		tiempoEspera(2000);
		captureScreen(locator,rutaCarpeta,nomTest,generarEvidencia,msn);
	}
	//METODO SCROLL EN MOBILE
	public void scrollVertical(By locator,File rutaCarpeta,String generarEvidencia,String msn, int xini,int yini, int yfinal, int iteraciones) throws Exception
	{
		String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();  
	...
	public void numeroSeparados (String numeros, By locator, File rutaCarpeta,String generarEvidencia,String msn ) throws Exception
	{
		String[] num= new String[numeros.length()] ;
			
		for (int i=0; i<numeros.length();i++) {
					num[i]=String.valueOf(numeros.charAt(i));
					click(localizadorVariable(locator,num[i]),rutaCarpeta,generarEvidencia,msn);
			}			 
	}
		
	//METODO DEL CLICK
		public void click(By locator,File rutaCarpeta,String generarEvidencia,String msn) throws Exception
		{
			try {
				String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		//METODO DEL CLICK
			public void clickTools(By locator,File rutaCarpeta,String generarEvidencia,String msn) throws Exception
			{
				String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
				captureScreen(locator,rutaCarpeta,nomTest,generarEvidencia,msn);
				driver.findElement(locator).click();
		...
		//METODO BORRAR
		public void borrar(By locator,File rutaCarpeta,String generarEvidencia,String msn) throws Exception
		{
			String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		//METODO ENVIAR TEXTO
		public void sendkey(String inputText, By locator,File rutaCarpeta, String generarEvidencia,String msn) throws Exception
		{
			try {
				String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		//METODO ENTER SUBMIN
		public void submit(By locator,File rutaCarpeta,String generarEvidencia,String msn) throws Exception
		{
			String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		public void closeCookie(By locator,File rutaCarpeta,String generarEvidencia,String msn)throws Exception
		{
			String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		public void captureScreen(By locator,File rutaCarpeta, String nomTest,String generarEvidencia,String msn) throws Exception
		{
			...
			informePdf.crearBody(locator, rutaImagen,msn);
		...
		public void selectOption( String inputText, By locator,File rutaCarpeta,String generarEvidencia,String msn) throws Exception
		{
			String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
			//CAPTURAMOS LA LISTA 
		...
		//METODO MOVER EL SCROLLBY
				...
				public void validacion(By localizador, File rutaCarpeta, String generarEvidencia,String msn) {
				    try {
				        driver.findElement(localizador).isEnabled();
				        click(localizador,rutaCarpeta,generarEvidencia,msn);
				    }catch (Exception e){
				        System.out.println(e);
				    }
				}
