...
public class GenerarReportePdf {
	...
	public void crearPlantilla(String nomTest,File rutaCarpeta)
	{
		...
		try 
		{
			...
			table.addCell(pos1);
			//GENERAR MARGEN
			documento.setMargins(30,30,30,33);
			//ABRIR DOCUMENTO
			documento.open();
			//INSERTAR LA IMAGEN
			documento.add(table);
    ...
    public void crearBody(By locator, String rutaImagen,String msn) throws DocumentException,MalformedURLException,IOException
    {
        ...
        parrafo.add("\n"+"Se realiza accion sobre el elemento: "+"\n"+locator1);
        //parrafo.add("\n"+msn);
